...
public class ModuleFiveTest
{
	...
	{
		/**
		 * Можно было бы спихнуть на Хард код и мэджик намберс, но это вводные тестовые данные,
		 * хотя их можно и в константы вынести.
		 */
		...
		try
		{
			ArraysUtil.findBiggestElement(new int[0]);
		} 
